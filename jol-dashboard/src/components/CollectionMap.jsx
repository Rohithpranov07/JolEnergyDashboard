...
export default function CollectionMap() {
  ...
  return (
    <div className="relative" style={{ height: 520 }}>
      ...
      {/* legend overlay */}
      <div className="absolute bottom-2 right-2 z-[1000] rounded-md border border-[#E0E0E0] bg-white/95 p-2 text-[11px] text-[#444444] shadow">
        ...
        <div className="mt-1.5 border-t border-[#EFEFEF] pt-1.5 text-[10px] text-[#888780]">
