...
const RANDOM_HEIGHTS = [35, 80, 45, 90, 60, 25, 75, 40, 85, 50, 70, 30, 95, 55, 65, 20, 80, 40, 60, 30, 70, 50, 90, 45, 85, 35, 75, 25, 95, 55, 65, 40];
const RANDOM_DURATIONS = [0.6, 0.9, 0.7, 0.5, 0.8, 0.6, 0.9, 0.7, 0.5, 0.8, 0.6, 0.9, 0.7, 0.5, 0.8, 0.6, 0.9, 0.7, 0.5, 0.8, 0.6, 0.9, 0.7, 0.5, 0.8, 0.6, 0.9, 0.7, 0.5, 0.8, 0.6, 0.9];
      ...
      <div className="w-full h-10 flex items-center justify-center gap-0.5 px-4">
        {[...Array(visualizerBars)].map((_, i) => (
          <div
            ...
            style={{
              height: `${RANDOM_HEIGHTS[i % RANDOM_HEIGHTS.length]}%`,
              animationDelay: `${i * 0.05}s`,
              animationDuration: `${RANDOM_DURATIONS[i % RANDOM_DURATIONS.length]}s`,
            }}
          />
        ))}
      </div>
      ...
      <TooltipProvider>
        ...
        >
          <div
            ref={ref}
            className={cn(
              "rounded-3xl border border-[#444444] bg-[#1F2023] p-2 shadow-[0_8px_30px_rgba(0,0,0,0.24)] transition-all duration-300 focus-within:border-gray-500",
